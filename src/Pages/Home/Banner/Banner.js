            ...
            <div className="hero min-h-screen bg-base-200 shadow-lg">
                <div className="hero-content flex-col lg:flex-row">
                    <div className='lg:w-1/2 text-center lg:text-left'>
                        ...
                        <p className="py-6 lg:w-3/4">Best internet service provider in your area which provides fully dedicated, super fast, cost-effective, secured internet connection.</p>
                        <div className='mt-2'>
