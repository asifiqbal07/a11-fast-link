            ...
            <div className="hero min-h-screen bg-base-200 shadow-lg mb-10 lg:rounded-3xl">
                <div className="hero-content flex-col lg:flex-row">
                    <div className='lg:w-1/2 text-center lg:text-left'>
                        ...
                        <div className='mt-2'>
                        <button className="btn bg-[#3078fb] border-0  hover:bg-white hover:text-[#3078fb] hover:border-[1px] hover:border-[#3078fb]">Our Services</button>
                        <button className="btn bg-white text-[#3078fb] border-[1px] border-[#3078fb]  hover:bg-[#3078fb] hover:text-white hover:border-[#3078fb] ml-5">Contact US</button>
                        </div>
                    </div>
