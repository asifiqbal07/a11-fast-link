...
const Packages = ({ pack }) => {
    ...
    return (
        <div maxLength={5}>
            <div className="card card-compact  bg-base-100 shadow-lg p-3  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 duration-300 rounded-none">
